...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: Colors.black),
...
// Customizable Dark Text Theme
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w400, color: Colors.white),
